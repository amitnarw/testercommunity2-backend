...
export const getBillingHistory = async (req: Request, res: Response) => {
    try {
        ...
        return sendSuccess(res, billingHistory, "Billing history fetched successfully");
    } catch (error) {
...
export const verifyPayment = async (req: Request, res: Response) => {
    try {
        ...
        if (order.status === "PAID") {
            return sendSuccess(res, { alreadyProcessed: true }, "Payment already processed");
        }
        ...
        const result = await prismaClient.$transaction(async (tx) => {
            ...
            const payment = await tx.payment.create({
                data: {
                    ...
                    amount: typeof paymentDetails.amount === 'string' ? parseInt(paymentDetails.amount) : paymentDetails.amount as number,
                    ...
                    fee: typeof paymentDetails.fee === 'string' ? parseInt(paymentDetails.fee) : paymentDetails.fee as number,
                    tax: typeof paymentDetails.tax === 'string' ? parseInt(paymentDetails.tax) : paymentDetails.tax as number,
...
export const initiateRefund = async (req: Request, res: Response) => {
    try {
        ...
        return sendSuccess(res, { status: "Refund initiated" }, "Refund flow started");
    } catch (error) {
