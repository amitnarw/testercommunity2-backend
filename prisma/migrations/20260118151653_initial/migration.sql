...
-- CreateEnum
CREATE TYPE "UserActionType" AS ENUM ('SUBMIT_APP', 'JOIN_TEST_REQUEST', 'JOIN_TEST_ACCEPT', 'COMPLETE_TEST', 'GIVE_FEEDBACK', 'RATE_APP', 'LOGIN', 'LOGOUT', 'UPDATE_PROFILE', 'REGISTER', 'RENEW_TOKENS', 'OTHER');
